...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBusiness(BusinessException ex) {
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                .body(new ErrorResponse(422, "Business Error", ex.getMessage(), LocalDateTime.now()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneral(Exception ex) {
        // IMPORTANTE: sin este log, cualquier error no controlado queda invisible
        // en la consola y el cliente solo ve "An unexpected error occurred".
